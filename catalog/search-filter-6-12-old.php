...
if($_POST['age_game'] == "6-12") // поиск фильтра возраст от 6 до 12
{
    $min_age = 6;
    $max_age = 12;
    //////////////////////////////
...
/////////////////////////////
    if($_POST['age_game'] == "6-12"  and empty($_POST['min_player']) and empty($_POST['min_time'])) { //если не выбирал кол-во игрок и время игры 
