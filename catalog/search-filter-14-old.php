...
if($_POST['age_game'] == "14") // поиск фильтра возраст от 14
{
    $age = 14;
    //////////////////////////////
    if($_POST['min_player'] >= 1 and $_POST['min_time'] >= 1){ //если выбрано кол-во игроков и время игры
        ...
        $result = $mysql->query("SELECT * FROM `game ad`  WHERE `sity` = '$city' AND `age` => '$age' AND `quality_max` <= '$max_player' AND `max_time` <= '$max_time'");
        ...
        Возраст: <span class="badge bg-white text-primary">от '.$age.' лет </span>
        </button>
        <button type="button" class="btn btn-primary mb-2 me-2">
    ...
    if($_POST['min_player'] >= 1) //если выбранно кол-во играков
    {
        ...
        $result = $mysql->query("SELECT * FROM `game ad`  WHERE `sity` = '$city' AND `age` <= '$age' AND `quality_max` <= '$max'");
   ...
   ///////////////////////////////
    if($_POST['min_time'] >= 1){ //если выбрано время игры
        ...
        $result = $mysql->query("SELECT * FROM `game ad`  WHERE `sity` = '$city' AND `age` <= '$age' AND `max_time` <= '$max'");
...
/////////////////////////////
    if($_POST['age_game'] == "14" and empty($_POST['min_player']) and empty($_POST['min_time'])) {    //если не выбирал кол-во игрок и время игры 
        $city = $_POST['city_choice'];
        
        $result = $mysql->query("SELECT * FROM `game ad` WHERE `sity` = '$city' AND `age` >= '$age' ");
